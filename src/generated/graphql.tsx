...
export type LaunchListQuery = (
  ...
  & { launches?: Maybe<Array<Maybe<(
    { __typename?: 'Launch' }
    & Pick<Launch, 'flight_number' | 'details' | 'launch_year' | 'launch_success' | 'mission_name' | 'mission_id' | 'launch_date_utc' | 'launch_date_unix'>
    & { links?: Maybe<(
      { __typename?: 'LaunchLinks' }
      & Pick<LaunchLinks, 'mission_patch_small' | 'mission_patch' | 'flickr_images'>
    )>, rocket?: Maybe<(
      { __typename?: 'LaunchRocket' }
